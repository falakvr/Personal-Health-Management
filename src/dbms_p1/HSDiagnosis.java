 ...
 * @author falak
 */
public class HSDiagnosis extends javax.swing.JFrame {
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        ...
        HSPatientInfo p = new HSPatientInfo();
        p.setVisible(true); 
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try
        {
            String dummy = "Delete from Diagnosis where patient_id ='"
                    + Setup.patientOfHS + "' and dname = '"+newDisease+"'";
            System.out.println(dummy);
            Setup.stmt.executeUpdate(dummy);
        }
        catch(SQLException e)
